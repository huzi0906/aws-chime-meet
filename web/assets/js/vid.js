const MEETING_SERVICE = ""; // Add the endpoint for the meeting service here
...
function updateTiles(meetingSession) {
  ...
  videoList.style.gridTemplateColumns = `repeat(2, 1fr)`; // Two columns for videos
  videoList.style.gap = "10px";
  videoList.style.overflowY = tiles.length > 4 ? "scroll" : "hidden"; // Add vertical scrollbar only when required
  videoList.style.overflowX = "hidden"; // Disable horizontal scrollbar
  ...
  tiles.forEach(tile => {
    ...
    if (!divElement) {
      ...
      divElement.style.backgroundColor = "#333"; // Dark background for video tiles
      divElement.style.borderRadius = "5px";
      divElement.style.boxShadow = "0 0 5px rgba(0, 0, 0, 0.5)";
      divElement.style.position = "relative";
      divElement.style.height = "300px"; // Set a fixed height for video tiles
      ...
      tileUserName.style.color = "#333";
      tileUserName.style.position = "absolute";
      tileUserName.style.bottom = "10px";
      tileUserName.style.left = "10px";
      tileUserName.style.margin = "0";
      tileUserName.style.padding = "5px";
      tileUserName.style.backgroundColor = "#ff8c00";
      tileUserName.style.borderRadius = "5px";
